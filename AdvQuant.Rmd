...
##Consider renaming Treatments (E/A/I -> Exclusion/Ambient/Irrigation), Region (X/M -> Xeric/Mesic) to fully spelled out words?
##Eventually, maybe not right now, we will need to calculate %cover (#species hits/#total hits possible/transect) and richness (#unique species/transect)
```
